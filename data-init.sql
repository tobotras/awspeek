DROP SCHEMA ximi CASCADE;
CREATE SCHEMA ximi;
SET SEARCH_PATH = ximi, public;

CREATE TABLE ximi.ASSETS (
       ID    SERIAL UNIQUE,
       NAME  VARCHAR(100) NOT NULL
);

CREATE TABLE ximi.DATA_CLASSES (
       ID    SERIAL UNIQUE,
       NAME  VARCHAR(100)
);
...
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA ximi TO ximi;

/* ----------------------------------- */

INSERT INTO ASSETS (NAME) VALUES ('AWS');
